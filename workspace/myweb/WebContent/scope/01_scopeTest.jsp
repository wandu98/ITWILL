...
/*
	●[JSP 내장객체]
	  ...
	  1)out				: 출력객체
	  2)pageContext		: JSP페이지 자체의 Context 제공7
	  3)request			: 요청에 관한 정보
...
-------------------------------------------------------------------------------------
	...
	● [내부변수값 가져오기]
	   1)pageContext.getAttribute("변수")
	   2)pageContext.getAttribute("변수")
	   3)pageContext.getAttribute("변수")
	   4)pageContext.getAttribute("변수")
----------------------------------------------------------------------------
*/
	//각 내부변수에 값 올리기
	...
	out.print("4)applicaiton 영역 : " + uname + "<hr>");
