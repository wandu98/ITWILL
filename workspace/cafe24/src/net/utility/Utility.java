...
public class Utility {
  ...
  /**
   * request.getRemoteAddr() 에서 가져 올 수 없는
   * Client IP를 가져옴
   * 참조: https://www.lesstif.com/pages/viewpage.action?pageId=20775886
   *
   * @return
   * String IP
   */
  public static String getClientIpAddr(HttpServletRequest request) {  //  은 서버값 가져옴
